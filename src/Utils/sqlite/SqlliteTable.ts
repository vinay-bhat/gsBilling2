...
export const insertQuerry = {
  ...
  InsertCounterPayments:
    "INSERT INTO counter_payments (payment_date, payment_types, multi_payment, branch, bill_id, user_name, payment_status, paid_amount) VALUES (?,?,?,?,?,?,?,?)",
